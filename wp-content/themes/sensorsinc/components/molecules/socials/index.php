...
gsc_define("socials", $defaults, function($data) {
  ...
  if ($data["style"]["type"] == "share") {
    ...
    $output .= "<li class='socials__social socials__social--facebook'><a href='https://www.facebook.com/sharer/sharer.php?u=" . urlencode(get_permalink()) . "'><span class='screen-reader-text'>Share to Facebook</span></a></li>";
    $output .= "<li class='socials__social socials__social--twitter'><a href='https://twitter.com/intent/tweet'><span class='screen-reader-text'>Share to Twitter</span></a></li>";
    $output .= "<li class='socials__social socials__social--email'><a href='mailto:?subject=I wanted you to see this site&amp;body=Check out this site " . urlencode(get_permalink()) . "'><span class='screen-reader-text'>Share this post via Email</span></a></li>";
